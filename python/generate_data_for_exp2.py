...
if __name__ == "__main__":
    ...
    # ITA-ECBS
    # 5 for empty 32*32 10-150
    # 5 for random 32*32 10-150
    # 4 for maze 32*32_2 10-150
    # 30 for warehouse 161*63 10-150
    # 15 for den312d 65*81 10-150
    # 20 for room 64*64_8, 10-150
    # 10 for orz900d 1491*656, 10-150
    # 10 for Boston 256*256 10-150

    # ECBS
    # empty 32*32 10-150
    # random 32*32 10-150
    # maze 32*32_2 10-150
    # warehouse 161*63 10-150
    # den312d 65*81 10-150
    # room 64*64_8, 10-150
    # orz900d 1491*656, 10-150
    # Boston 256*256 10-150
    total_goals = 0
    for agent_num in tqdm(range(10, 160, 10)):
